...
/**
 * Write a description of class RegistroPaciente here.
 * 
 * @author (your name) 
...
public class RegistroPaciente
{
    ...
    *   
    *       edad < 18  bono $2500
    *       edad>=18 && edad < 30  bono $3800
    *       edad>=30 && edad < 60  bono $4000
    *       edad >=60       bono $1500
    *       
    ...
    *  Crear la clase MenuRegistroPaciente
    ...
    public  void listarDatos(){
        p("Registro paciente " + nombre + " " + fechaHoraAtencion + " precio bono : "+ precioBono);
    }
